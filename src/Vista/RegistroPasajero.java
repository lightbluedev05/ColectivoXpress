...
public class RegistroPasajero extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setForeground(new java.awt.Color(41, 82, 85));
        jLabel10.setText("Telefono");

        telefono_input.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
    ...
    private void registrar_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrar_buttonActionPerformed
        ...
        try{
            ...
            JOptionPane.showMessageDialog(this, "Ingrese todos los datos de manera correcta", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        Pasajero pasajero = new Pasajero(nombre, correo, dni, fecha, contra, distrito, provincia, departamento, telefono);
