 ...
 * @author Mihae
 */
public class PasajeroComprarFiltrar extends javax.swing.JFrame {
    
        private Statement st;
        private Pasajero pasajero;
    
        // Agrega estos atributos como parámetros en el constructor
        private JTable tabla_viajes;  
        private JTable datos_conductor;
        private PasajeroCompraViaje panelCompraViaje;  // Nuevo atributo

        // Modifica el constructor
        public PasajeroComprarFiltrar(Statement st, Pasajero pasajero, PasajeroCompraViaje panelCompraViaje) {
            this.st = st;
            this.pasajero = pasajero;
            this.panelCompraViaje = panelCompraViaje;

            // Si se pasa un panel de compra de viaje, usar sus tablas
            if (panelCompraViaje != null) {
                this.tabla_viajes = panelCompraViaje.tabla_viajes;
                this.datos_conductor = panelCompraViaje.datos_conductor;
            } 
    ...
    private void cargarFiltrosAdicionales() {
       ...
       // Recopilar orígenes y destinos únicos de viajes disponibles
       for (Viaje viaje : viajes) {
           // Solo agregar viajes que están disponibles (activos)
           if (viaje.get_estado()) {
    ...
    protected void actualizarTablas(DefaultTableModel modeloViaje, DefaultTableModel modeloConductor) {
        if (panelCompraViaje != null) {
            // Actualizar las tablas del panel de compra de viajes
            panelCompraViaje.tabla_viajes.setModel(modeloViaje);
            panelCompraViaje.datos_conductor.setModel(modeloConductor);

            // Actualizar los ComboBox de IDs de viajes
            panelCompraViaje.ID_viajes.removeAllItems();
            panelCompraViaje.ID_c.removeAllItems();
            panelCompraViaje.ID_c.addItem("Todos");

            // Agregar los IDs de los viajes filtrados
            for (int i = 0; i < modeloViaje.getRowCount(); i++) {
                String idViaje = (String) modeloViaje.getValueAt(i, 0);
                panelCompraViaje.ID_viajes.addItem(idViaje);
                panelCompraViaje.ID_c.addItem(idViaje);
            }
        } else {
            // Si no hay panel de compra de viaje, actualizar las tablas locales
            tabla_viajes.setModel(modeloViaje);
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(año_desde, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(6, 6, 6)
                ...
                .addGap(6, 6, 6)
                .addComponent(dia_desde, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(año_hasta, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(6, 6, 6)
                ...
                .addGap(6, 6, 6)
                .addComponent(dia_hasta, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void buscar_porfiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar_porfiltroActionPerformed
        ...
        // En lugar de crear nuevos modelos, usa los existentes
        DefaultTableModel modeloViaje = (DefaultTableModel) panelCompraViaje.tabla_viajes.getModel();
        modeloViaje.setRowCount(0);  // Limpia solo los datos

        DefaultTableModel modeloConductor = (DefaultTableModel) panelCompraViaje.datos_conductor.getModel();
        modeloConductor.setRowCount(0);  // Limpia solo los datos
        ...
        for (Viaje viaje : viajes) {
            ...
            // Validar estado (solo viajes disponibles)
            boolean cumpleEstado = viaje.get_estado();
        ...
        if (modeloViaje.getRowCount() == 0) {
            JOptionPane.showMessageDialog(this, 
                "No se encontraron viajes disponibles en el rango de fechas y filtros seleccionados.", 
                "Sin Resultados", 
                JOptionPane.INFORMATION_MESSAGE);
        } else {
            // Llamar al método para actualizar las tablas
            actualizarTablas(modeloViaje, modeloConductor);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasajeroComprarFiltrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
