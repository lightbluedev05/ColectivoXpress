...
public class AdminPasajerosPanel2 extends javax.swing.JPanel {
    
    Admin admin;
    private Statement st;
    public AdminPasajerosPanel2(Admin admin, Statement st) {
        this.st = st;
        this.admin = admin;
        initComponents();
    ...
    private void correcciones_iniciales(){
        ...
        //tabla_pasajeros.setAutoResizeMode(JTable.AUTO_RESIZE_OFF);
        tabla_pasajeros.setBackground(new Color(230, 230, 230));
        
        //AJUSTE DE COLUMNA AL DARLE CLICK A LA ETIQUETA
        tabla_pasajeros.getTableHeader().addMouseListener(new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                
                int column = tabla_pasajeros.columnAtPoint(e.getPoint());
                
                setColumnWidthToFitContent(tabla_pasajeros, column);
            }
        });
    ...
    private void listar_pasajeros(){
        ...
        List<Pasajero> pasajeros = new PasajeroRepository(st).buscar_pro(dni, nombre, distrito, provincia, departamento, telefono);
        ...
        for(Pasajero pasajero:pasajeros){
            modelo.addRow(new Object[]{
                ...
                pasajero.get_provincia(),
                pasajero.get_departamento(),
    ...
    private void eliminar_pasajero(){
        int fila_seleccionada = tabla_pasajeros.getSelectedRow();
        ...
        ((DefaultTableModel) tabla_pasajeros.getModel()).removeRow(fila_seleccionada);
        JOptionPane.showMessageDialog(null, "Pasajero Eliminado", "Exito", JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void initComponents() {
        ...
        tabla_pasajeros.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "DNI", "Nombre", "Correo", "Fecha Nacimiento", "Distrito", "Provincia", "Departamento", "Telefono"
            }
        ) {
        ...
        jLabel2.setText("MÓDULO DE PASAJEROS");
        ...
        listar_pasajeros_button.setPreferredSize(new java.awt.Dimension(120, 20));
        ...
        jPanel3.add(listar_pasajeros_button, gridBagConstraints);
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(distrito_input, javax.swing.GroupLayout.DEFAULT_SIZE, 129, Short.MAX_VALUE)
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(departamento_input, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 126, Short.MAX_VALUE)
                        .addComponent(provincia_input, javax.swing.GroupLayout.Alignment.LEADING)))
