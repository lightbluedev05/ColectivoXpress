 ...
 * @author Mihae
 */
public class AdminPasajeroCrear extends javax.swing.JFrame {
    ...
    public AdminPasajeroCrear(Admin admin) {
        this.admin = admin;
        initComponents();
    ...
    private void registrar_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrar_buttonActionPerformed
        ...
        boolean registro = admin.crear_pasajero(nombre, correo, dni, fecha, contra, distrito, provincia, departamento);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminPasajeroCrear.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
