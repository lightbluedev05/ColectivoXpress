 ...
 * @author Mihae
 */
public class AdminPasajerosPanel extends javax.swing.JPanel {
    ...
    private void correcciones_iniciales(){
        ...
        tabla_datos_pasajero.getColumnModel().getColumn(0).setPreferredWidth(10);
        tabla_datos_pasajero.setBackground(new Color(230, 230, 230));
    }
    ...
    private void ver_datos_conductor(){
        DefaultTableModel modelo = (DefaultTableModel)tabla_datos_pasajero.getModel();
        modelo.setRowCount(0);
        ...
        if(pasajero==null){
            ...
            modelo.addRow(new Object[]{"DNI", pasajero.get_dni()});
            modelo.addRow(new Object[]{"Nombres", pasajero.get_nombre()});
            modelo.addRow(new Object[]{"Correo", pasajero.get_correo()});
            modelo.addRow(new Object[]{"Fecha de Nacimiento", pasajero.get_fecha_nacimiento()});
            modelo.addRow(new Object[]{"Distrito", pasajero.get_distrito()});
            modelo.addRow(new Object[]{"Provincia", pasajero.get_provincia()});
            modelo.addRow(new Object[]{"Departamento", pasajero.get_departamento()});
            modelo.addRow(new Object[]{"Contraseña", pasajero.get_contrasena()});
        }
        
        tabla_datos_pasajero.setModel(modelo);
    }
    ...
    private void eliminar_conductor(){
        ...
        resultado_eliminar.setText("Pasajero eliminado!!");
    }
    ...
    private void initComponents() {
        ...
        listar_pasajeros_button = new javax.swing.JButton();
        jLabel2 = new javax.swing.JLabel();
        buscar_pasajero_button = new javax.swing.JButton();
        dni_buscar_input = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        dni_eliminar_input = new javax.swing.JTextField();
        eliminar_pasajero_button = new javax.swing.JButton();
        resultado_eliminar = new javax.swing.JLabel();
        agregar_pasajero_button = new javax.swing.JButton();
        jScrollPane2 = new javax.swing.JScrollPane();
        tabla_pasajeros = new javax.swing.JTable();
        jScrollPane3 = new javax.swing.JScrollPane();
        tabla_datos_pasajero = new javax.swing.JTable();
        ...
        listar_pasajeros_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                listar_pasajeros_buttonActionPerformed(evt);
            }
        });
        ...
        buscar_pasajero_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                buscar_pasajero_buttonActionPerformed(evt);
            }
        });
        ...
        eliminar_pasajero_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                eliminar_pasajero_buttonActionPerformed(evt);
            }
        });
        ...
        agregar_pasajero_button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                agregar_pasajero_buttonActionPerformed(evt);
            }
        });
        ...
        jScrollPane3.setViewportView(tabla_datos_pasajero);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(179, 179, 179)
                                .addComponent(agregar_pasajero_button, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(57, 57, 57)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jLabel2)
                                    .addComponent(buscar_pasajero_button, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(dni_buscar_input)
                                    .addComponent(jLabel3)
                                    .addComponent(dni_eliminar_input)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(eliminar_pasajero_button, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(31, 31, 31)
    ...
    private void listar_pasajeros_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_listar_pasajeros_buttonActionPerformed
        listar_conductores();
    }//GEN-LAST:event_listar_pasajeros_buttonActionPerformed

    private void buscar_pasajero_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscar_pasajero_buttonActionPerformed
       ver_datos_conductor();
    }//GEN-LAST:event_buscar_pasajero_buttonActionPerformed

    private void eliminar_pasajero_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_eliminar_pasajero_buttonActionPerformed
        eliminar_conductor();
    }//GEN-LAST:event_eliminar_pasajero_buttonActionPerformed
    ...
    private javax.swing.JButton agregar_pasajero_button;
    private javax.swing.JButton buscar_pasajero_button;
    private javax.swing.JTextField dni_buscar_input;
    private javax.swing.JTextField dni_eliminar_input;
    private javax.swing.JButton eliminar_pasajero_button;
    private javax.swing.JLabel jLabel1;
    private javax.swing.JLabel jLabel2;
    private javax.swing.JLabel jLabel3;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JScrollPane jScrollPane3;
    private javax.swing.JButton listar_pasajeros_button;
    private javax.swing.JLabel resultado_eliminar;
    private javax.swing.JTable tabla_datos_pasajero;
